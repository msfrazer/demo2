...
class __TwigTemplate_bf0591365b4de1817d539490d7100918 extends Template
{
...
($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("filter-" . Twig\Extension\CoreExtension::replace(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "/var/www/html/web/themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig");
    }
